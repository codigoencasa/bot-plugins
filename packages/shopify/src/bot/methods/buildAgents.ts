    ...
    const agentsFlows: Employee[] = [
        {
            ...
            description: [
                ...
                'unicamente te activas cuando explicitamente el usuario intenta decir que quiere o esta preparado para realizar la compra',
                'en nuestra tienda en línea. Tu función principal es facilitar el proceso de pago, ya sea a través de PayPal, tarjeta de débito o crédito,',
                'asegurando una experiencia de compra fluida y eficiente.'
            ].join('\n'),
            flow: closerFlow,
        }
    ]
